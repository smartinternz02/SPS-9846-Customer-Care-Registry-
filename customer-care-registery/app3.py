...
def apply():
     ...
     if request.method == 'POST' :
         ...
         cursor = mysql.connection.cursor()
         cursor.execute('INSERT INTO job VALUES (% s, % s, % s, % s, % s, % s)', (session['id'],username, email,qualification,skills,job))
         mysql.connection.commit()
         msg = 'Your query has been successfully sent to our team soon they will contact you !'
